...
public final class InvoiceDiscountingApplicationRules {
    ...
    /**
     * When true, anchor sanction generates a program-terms document for eSign instead of stopping at SANCTIONED.
     * Default false preserves the existing anchor skip-esign behaviour.
     */
