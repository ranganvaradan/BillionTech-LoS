...
class SurePassCommercialBureauAdapterFixtureTest {

    private final ObjectMapper mapper = new ObjectMapper();
    private SurePassCommercialBureauAdapter adapter;

    @BeforeEach
    void setUp() {
        adapter = new SurePassCommercialBureauAdapter(mapper);
    }

    @Test
    void loadsFixture_supportsAndExtracts() throws Exception {
        JsonNode payload = load("provider-fixtures/surepass/commercial/commercial_minimal.json");
